...
public class CRUDEmployeeTest {
	...
	public void whenGetEmployee()  {
    	...
    	var domain = service.findById("testing");
	...
	public void whenPutEmployee() throws IOException {
		...
		var employee = service.findById("testing");
		...
		AssertionErrors.assertTrue("Updated successfully",service.save(employee));
	...
	public void whenDeleteEmployee()  {
		...
		service.deleteById("testing");

    	var test = service.findById("testing");
